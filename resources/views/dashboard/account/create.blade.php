                    ...
                    <form id="formAccountSettings" method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="npHp">Phone Number</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="bi bi-whatsapp"></i> </span>
                                        <input type="number" id="npHp" name="npHp" class="form-control"
                                            placeholder="0822-6742-9797" value="{{ old('npHp', $data->npHp ?? '') }}"
                                            required />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="body" type="hidden" name="body"
                                        value="{{ old('body', $data->body ?? '') }}" placeholder="Tentang Anda"
                                        required />
