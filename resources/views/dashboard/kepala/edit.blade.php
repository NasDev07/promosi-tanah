...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Kepala</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header">Edit Kepala</h5>
                    <div class="card-body">
                        <div class="col-lg-12">
                            <form method="POST" action="{{ route('kepala.update', $kepala->id) }}" class="mt-5"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="oldImage" value="{{ $kepala->image }}">
                                    @if ($kepala->image)
